        ...
        <div className={styles.top}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socialRow} aria-label="Social links">
              <a
                ...
                href="https://www.facebook.com/kanshahibachiexpress/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Kansha on Facebook"
              >
              ...
              <a
                className={styles.socialIcon}
                href="https://www.instagram.com/kansha_express/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Kansha on Instagram"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Kansha on Google Business"
              >
          ...
          <div className={styles.contactCol}>
            ...
            <div className={styles.infoBlock}>
              ...
              <address className={styles.infoValue}>
                303 Cooper Blvd Suite I, Warrensburg, MO 64093
              </address>
            </div>
            ...
            <div className={styles.infoBlock}>
              ...
              <Link
                ...
                href="mailto:ss.kansha@gmail.com"
              >
                ss.kansha@gmail.com
              </Link>
            </div>
